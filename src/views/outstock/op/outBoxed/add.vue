            ...
            <div class="wavePickContainer">
                ...
                <div class="leftPanel">
                    ...
                    <el-form label-width="80px" class="pickOpForm">
                        ...
                        <el-form-item label="拣货数量:">
                            <el-input v-model.trim="currentOp.pickQty" type="number" @keyup.enter="submitPick"
                                ref="pickQtyRef" placeholder="输入拣货数量后回车" />
                        </el-form-item>
                    </el-form>
                    <el-divider />
                    <!-- 操作记录表格 -->
                    ...
                    <div class="operationRecordTable">
                        <el-table :data="operationRecords" border style="width: 100%;" height="200">
                            <el-table-column show-overflow-tooltip prop="locationCode" label="库位" width="120" />
                            <el-table-column show-overflow-tooltip prop="barcode" label="商品条码" width="150" />
                            <el-table-column prop="stockQty" label="库存" width="80" />
                            <el-table-column prop="pickQty" label="待拣数量" width="85" />
                            <el-table-column show-overflow-tooltip prop="operateTime" label="操作时间" width="160" />
                        </el-table>
                    </div>
                </div>
                ...
                <div class="rightPanel">
                    ...
                    <div class="waveHeaderInfo">
                        <span>波次号：{{ waveNo || '-' }}</span>
                        <span>创建时间：{{ waveInfo.createTime || '-' }}</span>
                        <span>状态：{{ waveInfo.status || '-' }}</span>
                    </div>
                    ...
                    <el-table :data="wavePickDetails" border height="350" style="width: 100%; margin-bottom: 20px;"
                        ...
                        <el-table-column show-overflow-tooltip label="库位" width="140">
                        ...
                        <el-table-column show-overflow-tooltip prop="sku" label="SKU" width="150" />
                        <el-table-column show-overflow-tooltip prop="skuName" label="品名" width="180" />
                        <el-table-column prop="pickQty" label="待拣数量" width="83">
                            <template #default="{ row }">
                                <span>{{ row.pickQty - row.pickFinishedQty }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="pickFinishedQty" label="已拣数量" width="84" />
                    ...
                    <el-table :data="flattenedOrderDetails" border height="300" style="width: 100%;"
                        ...
                        <el-table-column label="品名" width="180" show-overflow-tooltip>
                            <template #default="{ row }">
                                {{ row.skuName }}
                            </template>
                        </el-table-column>
                        ...
                        <!-- 已拣数量列：假设orderSkuItems中有pickedQty字段，无则默认0 -->
                        <!-- <el-table-column label="已拣数量" width="100">
                            <template #default="{ row }">
                                {{ row.pickFinishedQty || 0 }}
                            </template>
                        </el-table-column> -->
                    </el-table>
                </div>
