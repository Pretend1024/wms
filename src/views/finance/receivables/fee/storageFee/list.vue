...
const handleReset = (data) => {
    ...
    initValues.value = { ...data, orgId: '', dateType: 10, dateRange: getDefaultDateRange(), feeMainTypeId: 3, statusIdList: [] };
    statusIdsArr.value = [];
...
onMounted(async () => {
    ...
    const feeTypeRes = await getFeeTypeEnumApi({ mainTypeId: 3 });
