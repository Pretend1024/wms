...
const initValues = ref({
    orgId: '', warehouseCode: '', customerCodeList: [], feeSubTypeId: '', statusId: '', createWay: '', orderNoList: [], billNoList: [], feeMainTypeId: 2, statusIdList: []
});
...
const handleReset = (data) => {
    ...
    initValues.value = { ...data, orgId: '', dateType: 10, dateRange: getDefaultDateRange(), feeMainTypeId: 2, statusIdList: [] };
    statusIdsArr.value = [];
