        ...
        <el-row>
            ...
            <el-col :span="24">
                <el-form-item :label="getLabel('currency')" prop="currency">
                    <el-select v-model="formData.currency" :placeholder="getPlaceholder('currency')" clearable disabled>
            ...
            <el-col :span="24">
                <el-form-item :label="getLabel('creditAmount')" prop="creditAmount">
                    <el-input v-model="formData.creditAmount" :placeholder="getPlaceholder('creditAmount')" v-number="3"
                        :disabled="isDisabled" />
                </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
                <el-form-item :label="getLabel('creditStartTime')" prop="creditStartTime">
                    <el-date-picker v-model="formData.creditStartTime" type="date"
                        ...
                        :disabled="isDisabled" :disabled-date="disabledBeginDate" />
                </el-form-item>
            </el-col>
            ...
            <el-col :span="24">
                <el-form-item :label="getLabel('creditEndTime')" prop="creditEndTime">
                    <el-date-picker v-model="formData.creditEndTime" type="date"
                        ...
                        :disabled="isDisabled" :disabled-date="disabledEndDate" />
                </el-form-item>
            </el-col>
