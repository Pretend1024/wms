        ...
        <div class="contentDiv  flex-container">
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="仓库代码:" prop="warehouseCode">
                            <el-select v-model="formData.warehouseCode" placeholder="请选择仓库代码" clearable>
                    ...
                    <el-col :span="6">
                        <el-form-item label="退件单号:">
                            <el-input v-model.trim="formData.orderNo" placeholder="不填则系统自动生成" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
            ...
            <div class="tableDiv">
                <returnOrderTable ref="parcelTableRef" :columns="parcelColumns" :data="parcelTableData"
                    @update:data="parcelTableData = $event" :hide-operation-visible="true" addButtonText="添加包裹">
                    ...
                    <template #statusId="scope">
                        <el-select v-model="scope.row.statusId" placeholder="请选择状态">
...
<script setup name="新增退件单">
import { getWhWarehouseApi } from '@/api/baseApi/wh.js'
import { getCustomerLikeQueryApi } from '@/api/baseApi/sku.js'
import { getProductShipwayBrandListApi } from '@/api/productApi/shipway.js'
import { getInstockReturnReturnOrderTypeEnumApi, addInstockReturnReturnOrderApi, getInstockReturnReturnParcelStatusEnumApi } from '@/api/instockApi/return.js'
    ...
    await formRef.value.validate(async (valid) => {
        if (valid) {
            try {
                ...
                const res = await addInstockReturnReturnOrderApi(data);
                if (res.success) {
