        ...
        <el-row>
            <el-col :span="12">
                <el-form-item :label="getLabel('atypeId')">
                    <el-select v-model="formData.atypeId" :placeholder="getPlaceholder('atypeId')" disabled>
            ...
            <el-col :span="12">
                <el-form-item :label="getLabel('btypeId')">
                    <el-select v-model="formData.btypeId" :placeholder="getPlaceholder('btypeId')" disabled filterable
...
onMounted(() => {
    getBType(props.formData.atypeId);
})
defineExpose({
    validate: () => {
