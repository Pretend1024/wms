        ...
        <el-row>
            ...
            <el-col :span="12">
                <el-form-item :label="getLabel('nameCn')" prop="nameCn">
                    <el-input v-model="formData.nameCn" autocomplete="off" readonly
                        :placeholder="getPlaceholder('nameCn')" />
                </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="24" v-show="formData.typeId == 10">
                <el-form-item :label="getLabel('code')" prop="code" :rules="formData.typeId == 10 ? [
                    ...
                    <el-input v-model="formData.code" autocomplete="off" readonly
                        :placeholder="getPlaceholder('code')" />
                </el-form-item>
            </el-col>
            <el-col :span="24" v-show="formData.typeId == 10">
                <el-form-item :label="getLabel('warehouseId')">
                    <el-select v-model="formData.warehouseId" filterable disabled
