        ...
        <div class="tableDiv">
            <hydTable :tableData="tableData" :columns="columns" :pagination="pagination" :enableSelection="true"
                ...
                <template #table-buttons>
                    ...
                    <el-button type="danger" @click="handleDel" v-permission="'delete'" :icon="DeleteFilled">{{ getButtonText('del') }}
                    </el-button>
                </template>
                <!-- 操作列按钮 -->
...
import { getWhLocationSizeTypeListApi, addWhLocationSizeTypeApi, updWhLocationSizeTypeApi, delWhLocationSizeTypeApi } from "@/api/baseApi/wh.js";
...
const dialogTitle = computed(() => t(`base_wh_locationSizeType_list.${dialogMode.value}Title`)); // 可根据模式调整标题
