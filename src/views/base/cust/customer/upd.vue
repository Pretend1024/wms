...
<script setup name="编辑客户">
import { Delete } from '@element-plus/icons-vue'
import { getOrgCountryListApi, getOrgListCompanyApi } from '@/api/baseApi/org.js';
import { getCustomerStatusEnumApi, getListFinancialUserEnumApi, getListSalesUserEnumApi, getCustomerLevelEnumApi, updCustomerApi, getCustomerByIdApi } from '@/api/baseApi/cust.js'
...
const handleSave = async () => {
    await formRef.value.validate(async (valid) => {
        if (valid) {
            ...
            const res = await updCustomerApi(form);
