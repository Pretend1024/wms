                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item :label="getLabel('code')" prop="code">
                            <el-input v-model="formData.code" readonly :placeholder="getPlaceholder('code')" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item :label="getLabel('name')" prop="name">
                            <el-input v-model="formData.name" readonly :placeholder="getPlaceholder('name')" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item :label="getLabel('statusId')" prop="statusId">
                            <el-select v-model="formData.statusId" disabled :placeholder="getPlaceholder('statusId')">
                ...
                <div class="tableDivItem" v-for="(item, index) in formData.carrierServiceAddDTOList" :key="index">
                    ...
                    <el-form :model="item" :rules="serviceRules" :ref="el => setServiceRef(el, index)"
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item :label="getLabel('serviceCode')" prop="code">
                                    <el-input v-model="item.code" readonly
                                        :placeholder="getPlaceholder('serviceCode')" />
                                </el-form-item>
                            </el-col>
                            <el-col :span="6">
                            ...
                            <el-col :span="6">
                                <el-form-item :label="getLabel('statusId')" prop="statusId">
                                    <el-select v-model="item.statusId" disabled
                            ...
                            <el-col :span="6">
                                <el-form-item :label="getLabel('remark')">
                                    <el-input type="textarea" autosize v-model="item.remark" readonly
                                        :placeholder="getPlaceholder('remark')" />
                                </el-form-item>
                            </el-col>
                        </el-row>
