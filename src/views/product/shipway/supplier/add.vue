<template>
    <div class="viewArea">
        <div class="contentDiv">
            ...
            <div class="tableDiv">
                <channel ref="channelRef" :formData="supplierChannelAddDTOList" @delete-item="handleDelChannel">
                </channel>
            </div>
            <div class="bottomDiv">
...
<script setup name="新增服务商">
import { QuestionFilled } from '@element-plus/icons-vue'
import { getOrgListCompanyApi } from '@/api/baseApi/org.js';
import { addProductSupplierApi, getProductSupplierStatusEnumApi, getProductSupplierTypeEnumApi, getProductSupplierAccountApiEnumApi, getProductSupplierApiJsonApi } from '@/api/productApi/shipway.js'
    ...
    await formRef.value.validate(async (valid) => {
        if (valid) {
            try {
                ...
                const res = await addProductSupplierApi(data);
                if (res.success) {
                    refreshStore.shouldRefreshSupplierList = true;
