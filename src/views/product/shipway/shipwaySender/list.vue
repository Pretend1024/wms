<template>
    <div class="viewArea">
        ...
        <batchOperationn :isVisible="delDialogVisible" :tableData="delData" :nameField="'id'" :nameLabel="'地址'"
...
import { getProductShipwayPostApi, getProductShipwayConfigTypeEnumApi, getProductShipwayListApi, addProductShipwayPostApi, updProductShipwayPostApi, delProductShipwayPostApi } from '@/api/productApi/shipway.js'
...
const dialogTitle = computed(() => t(`product_shipway_shipwaySender_list.${dialogMode.value}Title`)); // 可根据模式调整标题
...
onMounted(async () => {
    const typeRes = await getProductShipwayConfigTypeEnumApi()
